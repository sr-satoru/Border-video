...
class ComponenteEstiloLegenda(ttk.LabelFrame):
    ...
    def setup_ui(self):
        ...
        # Row 1: Cores
        self.criar_linha_cor(controls_frame, 1, "Cor Fonte:", self.font_color)
        self.criar_linha_cor(controls_frame, 2, "Cor Borda:", self.border_color)
        self.criar_linha_cor(controls_frame, 3, "Cor Fundo:", self.bg_color, allow_none=True)
    ...
    def criar_linha_cor(self, parent, row, label_text, var, allow_none=False):
