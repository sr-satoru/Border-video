def canvas_para_video(x_canvas, y_canvas, img_geometria, scale_factor, offset_borda=0):
    """
    Converte coordenadas do Canvas da UI para coordenadas do Vídeo (base 270p).
    ...
    # Remover o offset da borda para obter a coordenada original (base 270p)
...
def video_para_canvas(x_video, y_video, img_geometria, scale_factor, offset_borda=0):
    """
    Converte coordenadas do Vídeo (base 270p) para coordenadas do Canvas da UI.
    """
    img_x, img_y, _, _ = img_geometria
